# -*- coding: utf-8 -*-
"""
Created on Tue Jun  6 19:37:01 2023
...
save_path = './Txt-to-Xml/' # keep it blank

# txt_folder is txt file root that using darknet rectbox
txt_folder = './Txt-Format/'


# reading the classes.txt file
labelclassfile = open("classes.txt", "r")
data=labelclassfile.read()
labels= data.split("\n")
labelclassfile.close()
...
for line in fw:
    ...
    img_depth = Image.open(image_info).mode
    if img_depth=='RGB':
        img_depth=3
    else:
        img_depth=1
    ...
    ff.close()
print("The conversion is successful, please go to the directory to view.")